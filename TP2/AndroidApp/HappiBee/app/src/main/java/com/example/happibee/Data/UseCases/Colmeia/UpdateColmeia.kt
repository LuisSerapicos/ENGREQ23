...
class UpdateColmeia @Inject constructor(private val repository: ColmeiaRepositoryImpl){
    suspend operator fun invoke(colmeia: Colmeia) = repository.updateColmeia(colmeia)
}